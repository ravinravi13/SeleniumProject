...
//	String table_td ="td";
	...
	@Step("Select Department of filter as :{0}")
	public void SelectDpartment(String text)
	{
		SelectVisibleText(Findelement(Locators.xpath, "(//select[contains(@class,'form-select form-select-sm')])[1]"), text);
	}
